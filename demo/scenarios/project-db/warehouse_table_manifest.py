...
warehouse_tables: list[dict[str, Any]] = [
    ...
    },
    {
        "id": "wh_products",
        "sourceQuery": (
            "SELECT product_id AS productId, sku, category, list_price AS listPrice FROM wh_products"
        ),
    ...
    },
    {
        "id": "wh_orders",
        "sourceQuery": (
            "SELECT order_id AS orderId, customer_id AS customerId, status, "
            "total_amount AS totalAmount FROM wh_orders"
        ),
    ...
    },
    {
        "id": "wh_order_lines",
        "sourceQuery": (
            "SELECT line_id AS lineId, order_id AS orderId, sku, quantity, line_amount AS lineAmount "
            "FROM wh_order_lines"
        ),
    ...
    },
    {
        ...
        "sourceQuery": (
            ...
            "warehouse_code AS warehouseCode, qty FROM wh_inventory"
        ),
