...
| Demo | Production |
|------|------------|
| SQLite via `create_sqlite_connection` from `snapline.demo_shared` | **Postgres** — implement `DbConnectionLike` with your driver |
...
Uses **`run_warehouse_comparison`** from `snapline.core`:
